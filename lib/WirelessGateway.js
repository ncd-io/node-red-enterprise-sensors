	...
	sensor_data(payload, frame){
		...
		if(payload.length == 179){
			...
			if(typeof this.sensor_types[parsed.sensor_type] == 'undefined' && typeof this.sensor_libs[parsed.sensor_type] == 'undefined'){
				...
				// #OTF
			}else if(parsed.sensor_type == 21 || parsed.sensor_type == 24 || parsed.sensor_type == 33 || parsed.sensor_type == 39 || parsed.sensor_type == 29 || parsed.sensor_type == 51 || parsed.sensor_type == 54 || parsed.sensor_type == 55 || parsed.sensor_type == 80 ||  parsed.sensor_type == 81 || parsed.sensor_type == 82 || parsed.sensor_type == 84 || parsed.sensor_type == 86 || parsed.sensor_type == 87 || parsed.sensor_type == 97 || parsed.sensor_type == 98 || parsed.sensor_type == 99 || parsed.sensor_type == 103 || parsed.sensor_type == 110 || parsed.sensor_type == 111 || parsed.sensor_type == 112 || parsed.sensor_type == 114 || parsed.sensor_type == 117 || parsed.sensor_type == 118 || parsed.sensor_type == 127 || parsed.sensor_type == 128 || parsed.sensor_type == 129 || parsed.sensor_type == 130 || parsed.sensor_type == 180 || parsed.sensor_type == 181 || parsed.sensor_type == 202 || parsed.sensor_type == 217 || parsed.sensor_type == 515 || parsed.sensor_type == 519 || parsed.sensor_type == 531 || parsed.sensor_type == 537 || parsed.sensor_type == 538 || parsed.sensor_type == 543 || parsed.sensor_type == 545 || parsed.sensor_type == 554){
