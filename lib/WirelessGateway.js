	...
	var types = {
		...
		'107': {
			...
			parse: (d) => {
				var adc1 = signInt(d.slice(0, 2).reduce(msbLsb));
				var adc2 = signInt(d.slice(2, 4).reduce(msbLsb));
				var ma1 = (signInt(d.slice(4, 6).reduce(msbLsb)))/100.0;
				var ma2 = (signInt(d.slice(6, 8).reduce(msbLsb)))/100.0;
				var adc3 = signInt(d.slice(8, 10).reduce(msbLsb));
				var adc4 = signInt(d.slice(10, 12).reduce(msbLsb));
