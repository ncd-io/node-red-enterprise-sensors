...
module.exports = class WirelessSensor{
	...
	set_number_of_read_retries_539(sensor_mac, value){
		console.log('set_number_of_read_retries_539');
		var packet = [244, 55, 0, 0, 23, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	set_read_parameter_539(sensor_mac, value){
		console.log('set_read_parameter_539');
		...
		'539': {
			...
			parse: (d) => {
				return {
					...
					error_0_7: d.slice(2, 3),
					error_8_15: d.slice(3, 4),
					error_16_23: d.slice(4, 5),
					error_24_31: d.slice(5, 6),
