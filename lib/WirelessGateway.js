...
module.exports = class WirelessSensor{
	...
	config_set_led_acc_alert_threshold_p1_110(sensor_mac, value){
		console.log('config_set_led_acc_alert_threshold_p1_110');
		var packet = [244, 79, 0, 0, 80, 62, 1, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	config_set_led_acc_alert_threshold_p2_110(sensor_mac, value){
		console.log('config_set_led_acc_alert_threshold_p2_110');
		var packet = [244, 79, 0, 0, 80, 62, 2, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	config_set_led_vel_alert_threshold_p1_110(sensor_mac, value){
		console.log('config_set_led_vel_alert_threshold_p1_110');
		var packet = [244, 79, 0, 0, 80, 64, 1, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	config_set_led_vel_alert_threshold_p2_110(sensor_mac, value){
		console.log('config_set_led_vel_alert_threshold_p2_110');
		var packet = [244, 79, 0, 0, 80, 64, 2, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
