...
function sensor_types(parent){
	var types = {
		...
		'19': {
			...
			parse: (d) => {
				return {
					channel_1: parseFloat(((d.slice(0, 3).reduce(msbLsb))/1000.00).toFixed(2)),
					channel_2: parseFloat(((d.slice(4, 7).reduce(msbLsb))/1000.00).toFixed(2)),
				};
			}
		},
		'20': {
		...
		'28': {
			...
			parse: (d) => {
				return {
					channel_1: parseFloat(((d.slice(0, 3).reduce(msbLsb))/1000.00).toFixed(2)),
					channel_2: parseFloat(((d.slice(4, 7).reduce(msbLsb))/1000.00).toFixed(2)),
					channel_3: parseFloat(((d.slice(8, 11).reduce(msbLsb))/1000.00).toFixed(2))
				};
			}
		},
		'29': {
