			...
			parse: (payload, parsed, mac) => {
				...
				if(payload[8] === 1){
					...
					return {
						...
						x_ppv_inch_sec: payload.slice(14, 16).reduce(msbLsb) / 100,
						...
						y_ppv_inch_sec: payload.slice(26, 28).reduce(msbLsb) / 100,
						...
						z_ppv_inch_sec: payload.slice(38, 40).reduce(msbLsb) / 100,
