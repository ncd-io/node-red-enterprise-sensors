...
function sensor_types(parent){
	var types = {
		...
		'78': {
			...
			parse: (d) => {
				return {
					ferro_particles_lt_50_um: d.slice(0, 4).reduce(msbLsb)/100,
					...
					ferro_particles_total_24h: d.slice(28, 32).reduce(msbLsb)/100,
					non_ferro_particles_120_200_um: d.slice(32, 36).reduce(msbLsb)/100,
					non_ferro_particles_200_400_um: d.slice(36, 40).reduce(msbLsb)/100,
					non_ferro_particles_400_800_um: d.slice(40, 44).reduce(msbLsb)/100,
					non_ferro_particles_800_1600_um: d.slice(44, 48).reduce(msbLsb)/100,
					non_ferro_particles_gt_1600_um: d.slice(48, 52).reduce(msbLsb)/100,
					non_ferro_particles_total: d.slice(52, 56).reduce(msbLsb)/100,
					non_ferro_particles_total_24h: d.slice(56, 60).reduce(msbLsb)/100,
					velocity: d.slice(60, 64).reduce(msbLsb)/100,
					ferro_concentration: d.slice(64, 68).reduce(msbLsb)/100,
					non_ferro_concentration: d.slice(68, 72).reduce(msbLsb)/100
				};
			}
		},
		'79': {
