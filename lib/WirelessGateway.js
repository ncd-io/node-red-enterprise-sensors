...
module.exports = class WirelessSensor{
	...
	config_set_baud_rate_536(sensor_mac, value){
		console.log('config_set_baud_rate_536');
		var packet = [244, 55, 0, 0, 0, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	config_set_parity_bits_536(sensor_mac, value){
		console.log('config_set_parity_bits_536');
		var packet = [244, 57, 0, 0, 0, value];
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	config_set_stop_bits_536(sensor_mac, value){
		console.log('config_set_stop_bits_536');
