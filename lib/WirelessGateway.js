		...
		'74': {
			...
			'parse_fly': (frame) => {
				return {
					...
					'heater_duration': frame.slice(15, 17).reduce(msbLsb),
					'heater_temperature': frame.slice(17, 19).reduce(msbLsb) + ' °C',
					'hardware_id_1': frame[19],
					'hardware_id_2': frame[20],
					'hardware_id_3': frame[21],
		...
		'97': {
			...
			'parse_fly': (frame) => {
				...
				return {
					...
					'hardware_id_1': frame[23],
					'hardware_id_2': frame[24],
					'hardware_id_3': frame[25],
					'rate': frame.slice(26, 30).reduce(msbLsb),
					...
					'machine_values': {
						...
						'hardware_id_1': frame[22],
						'hardware_id_2': frame[24],
						'hardware_id_3': frame[25],
						'rate': frame.slice(26, 30),
		...
		'98': {
			...
			'parse_fly': (frame) => {
				...
				return {
					...
					'hardware_id_1': frame[25],
					'hardware_id_2': frame[26],
					'hardware_id_3': frame[27],
					'rate': frame.slice(28, 32).reduce(msbLsb),
