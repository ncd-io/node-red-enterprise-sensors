...
module.exports = class WirelessSensor{
	...
	firmware_send_manifest(sensor_mac, manifest){
		...
		console.log(manifest.map(function (x) {return x.toString(16);}).toString());
		console.log(packet.map(function (x) {return x.toString(16);}).toString());
		return this.config_send(sensor_mac, packet);
	}
	...
	config_set_sensor_temperature_offset_44(sensor_mac, value){
		...
		var packet = [244, 30, 0, 0, 0, 0, value];
		return this.config_send(sensor_mac, packet);
	}
