...
module.exports = class WirelessSensor{
	...
	parse(frame){
		...
		if(typeof this[type] == 'function'){
			...
			// #OTF
			var otf_devices = [23,26,39,45,48,52,78,79,80,81,82,84,88,89,91,101,102,107,519,520,521,531,537,1010,1011];
	...
	config_set_baudrate_1011(sensor_mac, value){
		console.log('config_set_baudrate_1011');
		var packet = [244, 32, 0, 0, 23, 0, value];
		let value_cmd = int2Bytes((value), 3);
		packet.push(...value_cmd);
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	...
	config_set_address_timer_1011(sensor_mac, value){
		console.log('config_set_address_timer_1011');
		var packet = [244, 40, 0, 0, 23, value];
		var value_cmd = int2Bytes(value, 2);
		packet.push(...value_cmd);
		console.log(packet);
		return this.config_send(sensor_mac, packet);
	}
	// config_reboot_1011(sensor_mac){
	// 	console.log('config_reboot_1011:' + sensor_mac );
	// 	var packet = [244, 64, 0, 0, 0, 5, 22, 23];
	// 	console.log(packet);
	// 	return this.config_send(sensor_mac, packet);
	// }
...
function sensor_types(parent){
	var types = {
		...
		'1011': {
			name: 'RS-485 Wireless Converter',
			parse: (d) => {
				return {
					data: d
				};
