		...
		return {
			...
			"motion_duration": {
				...
				"descriptions": {
					...
					"main_caption": "Sets the minimum amount of time that motion/impact must continuously persist before triggering an alert. This filters out single, brief vibrations or random background noise from causing false alarms."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
