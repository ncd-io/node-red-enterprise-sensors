	...
	const get_config_map = (firmware) => {
		...
		return {
			...
			"uptime_counter_probe_1": {
				"read_index": 60,
				"descriptions": {
					"title": "Accelerometer Uptime Probe 1",
					"main_caption": "Displays the total equipment uptime, as detected by the accelerometer (probe 1), in seconds."
				},
				"validator": {
					"type": "uint32be"
				},
			...
			"uptime_counter_probe_2": {
				"read_index": 64,
				"descriptions": {
					"title": "Accelerometer Uptime Probe 2",
					"main_caption": "Displays the total equipment uptime, as detected by the accelerometer (probe 2), in seconds."
				},
				"validator": {
					"type": "uint32be"
				},
