...
module.exports = (globalDevices, emitter) => {
	...
	const init_globalDevices_stream = (deviceAddr, payload, expected_packets, parsed, msg_type) => {
		...
		globalDevices[deviceAddr].packet_stream_timeout = setTimeout(() => {
			...
			emitter.emit('sensor_data-112', parsed);
	...
	const get_config_map = (firmware) => {
		...
		return {
			...
			"thermocouple_type": {
				...
				"html_id": "thermocouple_type_112"
			},
			// "thermocouple_filter_level": {
			// 	"read_index": 34,
			// 	"write_index": 23,
			// 	"descriptions": {
			...
			// 		"7": "Level 7"
			// 	},
			// 	"html_id": "filter_thermocouple_112"
			// },
			// "thermocouple_cj_resolution": {
			// 	"read_index": 35,
			// 	"write_index": 24,
			// 	"descriptions": {
			...
			// 		"1": "0.25⁰C"
			// 	},
			// 	"html_id": "cold_junction_thermocouple_112"
			// },
			// "thermocouple_adc_resolution": {
			// 	"read_index": 36,
			// 	"write_index": 25,
			// 	"descriptions": {
			...
			// 		"96": "12 Bits"
			// 	},
			// 	"html_id": "sample_resolution_thermocouple_112"
			// },
			// "thermocouple_num_of_samples": {
			// 	"read_index": 37,
			// 	"write_index": 26,
			// 	"descriptions": {
			...
			// 		"28": "128 Samples"
			// 	},
			// 	"html_id": "number_of_samples_thermocouple_112"
			// },
			// "thermocouple_operation_mode": {
			// 	"read_index": 38,
			// 	"write_index": 27,
			// 	"descriptions": {
			...
			// 		"2": "Burst Mode"
			// 	},
			// 	"html_id": "operation_mode_thermocouple_112"
			// },
			"thermocouple_measurement_type": {
				"read_index": 34,
				"write_index": 23,
				"descriptions": {
				...
				"html_id": "measurement_type_thermocouple_112"
			},
			"current_calibration": {
				"read_index": 35,
				"write_index": 24,
				...
				"html_id": "current_calibration_82"
			},
