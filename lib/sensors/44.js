		...
		return {
			...
			"scd_skipped_samples": {
				...
				"descriptions": {
					...
					"main_caption": "Sets the number of initial unstable CO2 samples the sensor discards before transmitting, so each reading reflects a settled measurement."
				},
				"default_value": 2,
				"validator": {
					"type": "uint8",
			...
			"temperature_offset": {
				...
				"descriptions": {
					...
					"main_caption": "Applies a temperature correction value in Celsius to offset internal self-heating and enclosure confinement, ensuring accurate ambient readings."
				},
				"default_value": 0,
				"validator": {
					"type": "uint16be",
