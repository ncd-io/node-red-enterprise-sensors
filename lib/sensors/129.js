...
module.exports = (globalDevices) => {
	...
	const get_config_map = (firmware) => {
		...
		return {
			...
			"adc_threshold_ch1": {
				...
				"write_index": 14,
				"descriptions": {
					"title": "Set Water Detection Threshold",
					"main_caption": "Sets the ADC raw value threshold. When the sensor reading exceeds this value, it will trigger an immediate data transmission."
				},
				"default_value": "0",
				"validator": {
					"type": "uint16be",
				...
				"html_id": "adc_threshold_128"
			},
			"adc_threshold_ch2": {
				"read_index": 27,
				"write_index": 16,
				"descriptions": {
					"title": "Set Water Detection Threshold (Channel 2)",
					"main_caption": "Sets the ADC raw value threshold. When the sensor reading exceeds this value, it will trigger an immediate data transmission."
				},
				"default_value": "0",
				"validator": {
				...
				"html_id": "adc_threshold_129"
			},
			"autockeck_interval": {
				"read_index": 29,
				"write_index": 18,
				"descriptions": {
					"title": "Set Threshold Alert Interval",
					"main_caption": "Defines the polling interval (in seconds) at which the sensor transmits data while the ADC value remains above the configured threshold."
				},
				"default_value": "0",
				"validator": {
					"type": "uint8",
				...
				"html_id": "auto_check_interval_128"
			},
			"auto_calibration_ch1": {
				"read_index": 30,
				"write_index": 19,
				"descriptions": {
					"title": "Set Auto Calibration",
					"main_caption": ""
				},
				"default_value": "0",
				"validator": {
				...
				"html_id": "auto_calibration_128"
			},
			"auto_calibration_ch2": {
				"read_index": 31,
				"write_index": 20,
				"descriptions": {
					"title": "Set Auto Calibration (Channel 2)",
					"main_caption": ""
				},
				"default_value": "0",
				"validator": {
	...
	const parse = (payload, parsed, mac) => {
		let report_type_bit = payload[7] >> 1;
		let report_type = report_type_bit?'Interrupt':'Regular';
		return {
			ch1_water_detect: payload[8],
			ch1_raw_value: payload.slice(10, 12).reduce(msbLsb),
			ch2_water_detect: payload[9],
			ch2_raw_value: payload.slice(12, 14).reduce(msbLsb),
	...
	return {
		type: 129,
		name: 'Two Channel Wireless Water Detect Sensor',
		parse,
