		...
		return {
			...
			"odr": {
				...
				"descriptions": {
					...
					"main_caption": "This will determine how many samples the output data has This would determine how many samples the output data has, which is directly related to the highest frequency components that can be measured. In accordance with the Nyquist equation: f_max = ODR/2.56 Hz",
					"sub_caption": "Note: Increasing the ODR to 25600Hz introduces significant noise in the vibration data as it allows more frequencies in the resulting data."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"sampling_duration": {
				...
				"descriptions": {
					...
					"main_caption": "Set the amount of time which the samples are taken in increments of 50ms. A value of 1= 50msec, 2= 100msec",
					"sub_caption": "Note: The sampling duration along with ODR dictate total samples taken per reading."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"lpf_coefficient": {
				...
				"descriptions": {
					...
					"sub_caption": "Example: ODR = 800 and Filter Coefficient = 4. LPF freq = 800/4 = 200Hz"
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"hpf_coefficient": {
				...
				"descriptions": {
					...
					"sub_caption": "Example: ODR = 800 and Filter Coefficient = 64. HPF freq = 800/64 = 12.5Hz"
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"full_scale_range": {
				...
				"descriptions": {
					...
					"sub_caption": "Example: +/- 8g would mean that it would measure at most up to 8g and down to -8g."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"axes_enabled": {
				...
				"descriptions": {
					"title": "Axes Enabled",
					"main_caption": "Set which axes X, Y, Z are enabled on the sensor"
				},
				"validator": {
					"type": "uint8"
				},
			...
			"sampling_interval": {
				...
				"descriptions": {
					...
					"sub_caption": "Note: For this sensor, this value functions as the sampling interval rather than a traditional delay."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"operation_mode": {
				...
				"descriptions": {
					...
					"sub_caption": "WARNING: If Mode is set to Time Domain (Raw) data or Auto Time Domain (Raw) data (in Smart Mode) it is recommended to also set the Destination Address (Auto Raw Destination Address in Smart mode) configuration to the address of your Receiver/Gateway."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"on_request_timeout": {
				...
				"descriptions": {
					...
					"main_caption": "Set how long device will stay awake in seconds and wait for Time Domain (Raw) request from command."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"deadband": {
				...
				"descriptions": {
					...
					"main_caption": "Filters out acceleration values below the dead band threshold, treating them as noise. This value determines the minimum acceleration would have to be for it to be registered as a measurement. Values below the threshold it would be perceived as 0.",
					"sub_caption": "Example: A value of 10 would mean that vibrations below 10mg would be considered as 0."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"motion_detection_threshold": {
				...
				"descriptions": {
					...
					"sub_caption": "Note: In Smart mode, a 'motion' transmission is conditioned by the Smart Mode Threshold and Smart Skip Interval."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"led_acceleration_alert_threshold": {
				...
				"descriptions": {
					...
					"sub_caption": "Only applies if LED Alert Mode is set to Acceleration."
				},
				"default_value": 10,
				"validator": {
					"type": "uint8",
			...
			"led_velocity_alert_threshold": {
				...
				"descriptions": {
					...
					"sub_caption": "Only applies if LED Alert Mode is set to Velocity."
				},
				"default_value": 10,
				"validator": {
					"type": "uint8",
			...
			"smart_accelerometer_threshold": {
				...
				"write_index": 25,
				"descriptions": {
					"title": "Set Smart Mode Threshold",
					"main_caption": "If RMS acceleration is above this in any axis, it will send data. This will be an integer value that increments the interrupt threshold by 50 mg. A value of 1 means to wake the sensor if acceleration is above 50 mg, 2 means 100 mg, etc.",
					"sub_caption": "Note: This feature only works when the sensor is operating in Smart Mode."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"raw_packet_length": {
				...
				"descriptions": {
					...
					"main_caption": "Set the size of the data payload the sensor sends when it transmit a message.",
					"sub_caption": "Note: For the 2.4GHz version you need to operate with a 55 Byte payload."
				},
				"default_value": 3,
				"validator": {
					"type": "uint8",
			...
			"auto_raw_interval": {
				...
				"descriptions": {
					...
					"main_caption": "Set the Auto Time Domain (Raw) data transmission Interval, this interval is multiplied by the sample interval to determine how often the sensor should automatically transmit Time Domain (Raw) data. The Auto Raw interval is determined by the sample interval value. Example: If the Auto Raw value is set to 1 and the sample interval is set to 10 minutes, Time Domain (Raw) data will be transmitted automatically every 10 minutes. If the Auto Raw value is set to 5 and the sample interval is set to 10 minutes, Time Domain (Raw) data will be transmitted automatically every 50 minutes.",
					"sub_caption": "Note: This feature only works when the sensor is operating in Smart Mode. Auto Raw Transmission is disabled by default. Setting an interval value enables it, while setting it to 0 disables it."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"auto_raw_destination_address": {
				...
				"descriptions": {
					...
					"sub_caption": "Note: This feature only works when the sensor is operating in Smart Mode. Default value: 0000FFFF for Broadcast Mode. Example of targeted address: 41D5EC37"
				},
				"default_value": "0000FFFF",
				"validator": {
					"type": "mac",
			...
			"sync_interval": {
				...
				"descriptions": {
					...
					"main_caption": "Set the interval at which the sensor will transmit SYNC packets. SYNC packets are sent by the sensor to indicate that it is checking for reconfiguration. This determines how often the sensor should check in for updated configurations."
				},
				"default_value": 60,
				"validator": {
					"type": "uint16be",
			...
			"rpm_compute_status": {
				...
				"descriptions": {
					...
					"main_caption": "Enable/Disable Revolutions Per Minute Calculate Status. When a measurement sample is taken you can choose to not calculate the RPM, this will shorten the measurement time and save on battery."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"motion_to_sampling_delay": {
				...
				"descriptions": {
					...
					"sub_caption": "Only applies to sensor with firmware version 6 and above."
				},
				"default_value": 100,
				"validator": {
					"type": "uint8",
			...
			"max_motion_tx_per_interval": {
				...
				"descriptions": {
					...
					"sub_caption": "Default value: 1. Note: Setting this to a higher value will drain the battery."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
