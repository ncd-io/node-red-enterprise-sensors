...
module.exports = (globalDevices, emitter) => {
	...
	const concat_fft_data = (deviceAddr, mode, msg_type) => {
		...
		switch (globalDevices[deviceAddr].fsr) {
			...
			case 4: fsr_mult = 0.00098; break;
			case 5: fsr_mult = 0.00195; break;
		}
		switch (globalDevices[deviceAddr].fsr) {
			...
			case 4: fsr_text = "32g"; break;
			case 5: fsr_text = "64g"; break;
		}
		...
		return {
			...
			"odr": {
				...
				"descriptions": {
					...
					"main_caption": "This determines the frequency of sampling during the Sampling Duration. Directly related to the highest frequency components that can be measured in accordance with the Nyquist equation: f_max = ODR/2.56 Hz",
					"note": "Note: Increasing the ODR to 25600Hz introduces significant noise in the vibration data as it allows more frequencies in the resulting data."
				},
				"default_value": 14,
				"validator": {
					"type": "uint8",
			...
			"sampling_duration": {
				...
				"descriptions": {
					...
					"main_caption": "Set the amount of time over which the vibration samples are taken in increments of 50ms. A value of 1= 50msec, 2= 100msec",
					"note": "Note: The sampling duration along with ODR dictate total samples taken per reading."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"lpf_coefficient": {
				...
				"descriptions": {
					...
					"main_caption": "This setting will set the LPF freq to ODR divided by Selected Value",
					"note": "Example: ODR = 800 and Filter Coefficient = 4. LPF freq = 800/4 = 200Hz"
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"hpf_coefficient": {
				...
				"descriptions": {
					...
					"main_caption": "This setting will set the HPF freq to ODR divided by Selected Value",
					"note": "Example: ODR = 800 and Filter Coefficient = 64. HPF freq = 800/64 = 12.5Hz"
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"full_scale_range": {
				...
				"descriptions": {
					...
					"note": "Example: +/- 8g would mean that it would measure at most up to 8g and down to -8g."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"axes_enabled": {
				...
				"descriptions": {
					"title": "Axes Enabled",
					"main_caption": "Not implemented. Set which axes X, Y, Z are enabled on the sensor."
				},
				"validator": {
					"type": "uint8"
				},
			...
			"sampling_interval": {
				...
				"descriptions": {
					...
					"main_caption": "Set how often the sensor will wake to take readings and evaluate/transmit measurement data."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"filter_status": {
				...
				"write_index": 17,
				"descriptions": {
					"title": "LPF/HPF Filtering",
					"main_caption": "Enable/Disable built-in filters"
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"on_request_timeout": {
				...
				"write_index": 20,
				"descriptions": {
					"title": "On Request Timeout",
					"main_caption": "Set how long device will stay awake in seconds and wait for Time Domain (Raw) Request commands."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"deadband": {
				...
				"descriptions": {
					...
					"note": "Example: A value of 10 would mean that vibrations below 10mg would be considered as 0."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"motion_detection_threshold": {
				...
				"write_index": 22,
				"descriptions": {
					"title": "Acceleration Wake/Interrupt Threshold",
					"main_caption": "Set a motion detection threshold for the sensor to trigger a data transmission. This is an interrupt-based configuration, making it ideal for devices with minimal workload or uptime. The transmitted message will have a msg_type property of 'motion'. This will be an integer value that increments the interrupt threshold by 50mg. A value of 1 wakes the sensor if acceleration is above 50mg, 2 means 100mg, etc. Valid Input Range: 0 - 40. A value of 0 will disable this feature",
					"note": "In Smart mode, a 'motion' transmission is conditioned by the Smart Mode Acceleration Threshold and Smart Mode Skip Count."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"led_acceleration_alert_threshold": {
				...
				"write_index": 23,
				"descriptions": {
					"title": "LED Acceleration Threshold",
					"main_caption": "Set the minimum acceleration value to make LED indicator red. This will be an integer value that increments the threshold by 50mg. A value of 1 means turn the LED red if acceleration is above 50mg, 2 means 100mg, etc.",
					"note": "Only applies if LED Alert Mode is set to Acceleration."
				},
				"default_value": 10,
				"validator": {
					"type": "uint8",
			...
			"led_velocity_alert_threshold": {
				...
				"descriptions": {
					...
					"main_caption": "Set the minimum velocity value to make LED indicator red. This will be an integer value that increments the threshold by 2mm/second. A value of 1 means turn the LED red if velocity is above 2mm/sec, 2 means 4mm/second, etc.",
					"note": "Only applies if LED Alert Mode is set to Velocity."
				},
				"default_value": 10,
				"validator": {
					"type": "uint8",
			...
			"smart_accelerometer_threshold": {
				...
				"write_index": 25,
				"descriptions": {
					"title": "Smart Mode Acceleration Threshold",
					"main_caption": "If RMS acceleration is above this in any axis during a reading while the Sensor is in Smart Mode, the sensor will send data. If the readings are below this threshold the data may not be sent in accordance with the Smart Mode Skip Count. This will be an integer value that increments the interrupt threshold by 50 mg. A value of 1 means to transmit the data if acceleration is above 50 mg, 2 means 100 mg, etc.",
					"note": "Note: This feature only works when the sensor is operating in Smart Mode."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"led_alert_mode": {
				...
				"descriptions": {
					...
					"main_caption": "Choose whether the LED indicator should be based on Acceleration or Velocity"
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"raw_packet_length": {
				...
				"write_index": 27,
				"descriptions": {
					"title": "Raw Data Payload Length",
					"main_caption": "Set the size of the data payload the sensor sends when it transmits a single time series packet.",
					"note": "Note: For the 2.4GHz version you need to operate with a 55 Byte payload."
				},
				"default_value": 3,
				"validator": {
					"type": "uint8",
			...
			"auto_raw_interval": {
				...
				"write_index": 28,
				"descriptions": {
					"title": "Auto Raw Interval",
					"main_caption": "Set the Auto Time Domain (Raw) data transmission Interval, this interval is multiplied by the sample interval to determine how often the sensor should automatically transmit Time Domain (Raw) data. The Auto Raw Interval is co-determined by the Sampling Interval value. Example: If the Auto Raw Interval is set to 1 and the sample interval is set to 10 minutes, Time Domain (Raw) data will be transmitted automatically every 10 minutes. If the Auto Raw Interval is set to 5 and the Sampling Interval is set to 10 minutes, Time Domain (Raw) data will be transmitted automatically every 50 minutes.",
					"note": "Note: This feature only works when the sensor is operating in Smart Mode. Auto Raw Transmission is disabled by default. Setting an interval value enables it, while setting it to 0 disables it."
				},
				"default_value": 0,
				"validator": {
					"type": "uint8",
			...
			"auto_raw_destination_address": {
				...
				"length": 4,
				"descriptions": {
					"title": "Auto Raw Destination Address",
					"main_caption": "Set the address where the Auto Time Domain (Raw) data will be transmitted, we recommend setting this to your gateway's address.",
					"note": "Note: This feature only works when the sensor is operating in Smart Mode. Default value: 0000FFFF for Broadcast Mode. Example of targeted address: 41D5EC37"
				},
				"default_value": "0000FFFF",
				"validator": {
					"type": "mac",
			...
			"smart_mode_skip_count": {
				...
				"write_index": 33,
				"descriptions": {
					"title": "Smart Mode Skip Count",
					"main_caption": "Sensor will skip sending data this many times if vibration is below the smart threshold.",
					"note": "Note: This feature only works when the sensor is operating in Smart Mode."
				},
				"default_value": 0,
				"validator": {
			...
			"sync_interval": {
				...
				"write_index": 34,
				"descriptions": {
					"title": "SYNC Request Interval",
					"main_caption": "Set the interval at which the sensor will transmit SYNC requests. SYNC packets are sent by the sensor to indicate that it is checking for reconfiguration. This determines how often the sensor should check in for updated configurations."
				},
				"default_value": 60,
				"validator": {
					"type": "uint16be",
			...
			"rpm_compute_status": {
				...
				"descriptions": {
					...
					"main_caption": "Enable/Disable Revolutions Per Minute Calculation on the sensor. Disabling RPM Calculation will shorten sensor's time awake and save on battery."
				},
				"default_value": 1,
				"validator": {
					"type": "uint8",
			...
			"max_raw_samples": {
				...
				"write_index": 37,
				"descriptions": {
					"title": "Max Raw Samples",
					"main_caption": "Set the maximum number of samples the sensor captures for Time Domain (Raw) data, by reducing the sample duration."
				},
				"default_value": 4096,
				"validator": {
					"type": "uint16be",
			...
			"motion_to_sampling_delay": {
				...
				"write_index": 39,
				"descriptions": {
					"title": "Motion to Sampling Delay",
					"main_caption": "Once motion is detected, the sensor will wait for the configured duration before sampling and computing vibration data. 1= 50msec, 2= 100msec, 100= 5000msec (5sec)",
					"note": "Only applies to sensor with firmware version 6 and above."
				},
				"default_value": 100,
				"validator": {
					"type": "uint8",
			...
			"max_motion_tx_per_interval": {
				...
				"write_index": 40,
				"descriptions": {
					"title": "Max Motion Transmissions Per Interval",
					"main_caption": "Set the number of times the sensor will send data due to motion triggers per Sampling Interval.",
			...
			"uptime_counter": {
				...
				"descriptions": {
					...
					"main_caption": "Displays the total equipment uptime, as detected by the accelerometer, in seconds."
				},
				"default_value": 0,
				"validator": {
					"type": "uint32be",
